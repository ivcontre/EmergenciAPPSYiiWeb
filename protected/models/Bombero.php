...
/**
 * This is the model class for table "bombero".
 *
 * The followings are the available columns in table 'bombero':
 * @property integer $id
 ...
 */
class Bombero extends CActiveRecord
{
	/**
	 ...
	 * @return Bombero the static model class
	 */

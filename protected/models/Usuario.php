...
class Usuario extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('numero_telefono, id_tipo_usuario, nombre, apellido, correo, password, estado_alerta, latitud, longitud', 'required'),
			...
			array('numero_telefono, id_tipo_usuario, nombre, apellido, correo, password, estado_alerta, latitud, longitud', 'safe', 'on'=>'search'),
		);
	}

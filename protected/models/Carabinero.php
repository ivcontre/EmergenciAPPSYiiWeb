...
/**
 * This is the model class for table "carabinero".
 *
 * The followings are the available columns in table 'carabinero':
 * @property integer $id
 ...
 */
class Carabinero extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('nombre, direccion, id_comuna, telefono, x, y', 'required'),
			...
			array('id, nombre, direccion, id_comuna, telefono, x, y', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return Carabinero the static model class
	 */

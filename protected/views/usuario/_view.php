...
<div class="view">
	...
	<?php echo CHtml::link(CHtml::encode($data->numero_telefono), array('view', 'id'=>$data->numero_telefono)); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('estado_alerta')); ?>:</b>
	<?php echo CHtml::encode($data->estado_alerta); ?>
	<br />

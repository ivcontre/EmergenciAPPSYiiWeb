       ...
       if($resultado){
           if($cantidad_usuarios == 0){
               $mail = new PHPMailer();
                ...
                $mail->setFrom('EmergenciAPPS@gmail.com', 'EmergenciAPPS');
                $mail->addReplyTo('EmergenciAPPS@gmail.com', 'EmergenciAPPS');
                ...
                $mensaje = $mensaje."<p>Información de ".$usuario_nombre." ".$usuario_apellido."</p>";
